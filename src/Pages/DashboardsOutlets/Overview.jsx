...
const Overview = () => {
  ...
  return (
    <div className="flex flex-col h-lvh bg-white p-6 space-y-6 overflow-auto w-full xl:w-[102rem] 3xl:w-[138rem]">
      <div className="flex items-center justify-between w-full gap-3">
        <h1 className="text-xl font-bold text-blue-800">Overview</h1>
        <button
          onClick={() => {
            setEditingContest(null);
            setIsModalOpen(true);
          }}
          className="bg-blue-600 text-white hover:bg-blue-500 px-4 py-2 rounded-lg flex items-center gap-2 transition-colors duration-200"
        >
